...
extension AppDelegate {
	...
	@MainActor func clearAllIconCaches() async {
		...
		// Icon discovery reads the home page’s parsed <head>, so leaving that cached — a failure
		// record especially — makes clearing everything else a no-op for a scraped icon.
